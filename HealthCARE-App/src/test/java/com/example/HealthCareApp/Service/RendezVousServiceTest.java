...
class RendezVousServiceTest {
    ...
    void getAll() {
        ...
        List<RendezVousGetDTO> list = service.getAll();
    ...
    void findByPatient() {
        ...
        List<RendezVousGetDTO> result = service.findByPatient(patient.getId());
    ...
    void findByMedcin() {
        ...
        List<RendezVousGetDTO> result = service.findByMedcin(medcin.getId());
